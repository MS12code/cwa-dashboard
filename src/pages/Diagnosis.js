...
// ✅ Moved outside the component to avoid ESLint warnings
const mockAgentData = [
  {
      ...
      <div className="p-8">
        ...
        {symptoms.length === 0 ? (
          <Card className="bg-drdo-blue/30 border-drdo-blue-light backdrop-blur-sm mb-6">
            <CardHeader>
              <CardTitle className="text-white text-lg">No symptoms selected</CardTitle>
            </CardHeader>
          ...
          <>
            {results.map((result, index) => (
              <Card
                key={index}
                className="bg-drdo-blue/30 border-drdo-blue-light backdrop-blur-sm mb-6"
              >
                <CardHeader>
            ...
            {results.length === 0 && (
              <div className="text-drdo-gray-light italic">
